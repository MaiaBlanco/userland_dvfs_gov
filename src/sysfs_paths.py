...
fn_core_max=fn_cluster_base+"cpuinfo_max_freq"
fn_core_min=fn_cluster_base+"cpuinfo_min_freq"
fn_core_freq_range=fn_cluster_base+"cpuinfo_available_frequencies"
fn_core_cpus=fn_cluster_base+"affected_cpus"
#fn_core_govs=fn_cluster_base+"scaling_cur_governor"
fn_core_gov=fn_cluster_base+"scaling_governor"
fn_core_freq_read=fn_cluster_base+"cpuinfo_cur_freq"
fn_core_freq_set=fn_cluster_base+"scaling_setspeed"
fn_core_max_set=fn_cluster_base+"scaling_max_freq"
fn_core_min_set=fn_cluster_base+"scaling_min_freq"
